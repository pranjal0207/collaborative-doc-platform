...
require (
	...
	pranjal0207/collaborative-doc-platform/collaboration-service v0.0.0
...
replace pranjal0207/collaborative-doc-platform/collaboration-service => ../collaboration-service
